...
public class RabbitReciver {
    private static final Logger log= LoggerFactory.getLogger(RabbitReciver.class);
    /**
     * direct队列监听一.
     *
    ...
    public void receiver1(Message message, Channel channel) throws IOException {
        ...
        log.debug("节点一USER_QUEUE_1 "+new String(message.getBody()));
    }
    ...
    public void receiver2(Message message, Channel channel,@Header(AmqpHeaders.DELIVERY_TAG) long tag) throws IOException {
        ...
        log.debug("节点一USER_QUEUE_2 "+new String(message.getBody()));
    }
}
